...
SRC_URI_append_ec401w = " file://get-wlan-band.sh"
...
do_install_append_ec401w() {
    ...
    install -m 0744 ${WORKDIR}/get-wlan-band.sh ${D}${bindir}/get-wlan-band
}
