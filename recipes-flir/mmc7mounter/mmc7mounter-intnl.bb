...
SYSTEMD_SERVICE_${PN} = "FLIR-internal.mount"
SRC_URI_append += " \
	       file://FLIR-internal.mount \
"
...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/FLIR-internal.mount ${D}${systemd_unitdir}/system/FLIR-internal.mount    
}
