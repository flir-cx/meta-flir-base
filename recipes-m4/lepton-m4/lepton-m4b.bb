SUMMARY = "Cortex M4 Lepton b:320x240"
...
SRCREV = "a4b25738dbbb680c321315884d4f27b23ed1cb23"
PV = "0.${SRCPV}"
PR = "r1"
...
M4_BIN = "imx7ulpm4.bin.irb"

do_install() {
    install -d ${D}/boot
    install -m 0755 ${S}/${M4_BIN}  ${D}/boot/imx7ulpm4b.bin
}

FILES_${PN} += "/boot/imx7ulpm4b.bin "
